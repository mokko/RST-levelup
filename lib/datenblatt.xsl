<xsl:stylesheet version="2.0"
	...
	<xsl:template name="documentLevel">
		...
		<xsl:result-document href="{$file}" method="html"
			encoding="UTF-8">
			<html>
				<head>
				...
				<body>
					<xsl:apply-templates
						select="/mpx:museumPlusExport/mpx:sammlungsobjekt[mpx:ausstellung = $exhibit]">
	...
	<xsl:template match="/mpx:museumPlusExport/mpx:sammlungsobjekt">
		...
		<table border="0" width="800">
			<xsl:variable name="stdbld"
				select="/mpx:museumPlusExport/mpx:multimediaobjekt[mpx:verknüpftesObjekt eq $objId and mpx:standardbild]" />
			<tr>
				<td colspan="2">
					<h1>
